...
7. **Failed fund-moving entries need exponential backoff in the listing query** (1min→6h cap; fresh entries due immediately) or a permanently-failing row hot-loops the external service every sweep.
