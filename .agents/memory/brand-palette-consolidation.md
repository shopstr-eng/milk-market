...
**Why:** the user removed upstream Shopstr light/dark theming during the Self-sown rebrand (2026-09). Only four brand colors exist; use them unconditionally. The `darkMode: boolean` fields on shop profiles are the separate *seller storefront theme* feature — do not strip them.
