...
**Why:** the user removed upstream Shopstr light/dark theming during the Self-sown rebrand (2026-09). The `darkMode: boolean` fields on shop profiles are the separate *seller storefront theme* feature — do not strip them.
