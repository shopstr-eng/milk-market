...
const PARAGRAPHS = [
  ...
  'Milk in particular is what has brought me to this point of contention against our current food system. Raw milk, the milk of our ancestors having been drunk for centuries, is one of the most regulatorily divisive drinks one can purchase and consume, if you\'re even able to. In countries we generally consider "developed" like Canada, Australia, or Singapore, raw milk is completely outlawed. In my home country, the United States, it\'s a federal crime to cross state lines with raw milk for sale. Even within the states that do allow it\'s sale, the regulatory bodies do their best to limit it\'s distribution, allowing only on-farm sales, herdshare agreements, or legal loopholes like "pet food" or "cosmetic use" labeling. And when these regulations "aren\'t followed" or are rather deemed as not being followed, the government bodies that regulate these products have even come to resort to raids with guns drawn, as if your local farmer and co-op are mafia members or kingpins. Milk, of all things, is treated like a Schedule I substance. Meanwhile you can find used needles and heroine dealers in some of the biggest cities across the western world, often with little to no repurcusions or action to make this better.',
